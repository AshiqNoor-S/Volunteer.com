  ...
  return (
    <ProfileStyle>
      <div className="profile-banner-imgs" >
        <img src="./images/profile_banner.jpg" className="banner" style={{ width: '100%' }} />
        <img src="./images/user_icon.png" className="profile-pic" />
      </div>
